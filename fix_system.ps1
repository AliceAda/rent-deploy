...
// 经纪人
const agents = ref<Array<{ id: number; name: string; phone: string; agency: string; status: string; commission: number; createdAt: string }>>([])
...
'@
$content | Out-File -FilePath 'D:\Project\rent-deploy\src\views\admin\SystemManage.vue' -Encoding UTF8
Write-Host 'SystemManage.vue fixed with Agent management'
